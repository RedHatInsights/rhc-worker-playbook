...
_REGISTRATIONREQUEST_FEATURESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="yggdrasil.RegistrationRequest.FeaturesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="yggdrasil.RegistrationRequest.FeaturesEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_REGISTRATIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="handler",
            full_name="yggdrasil.RegistrationRequest.handler",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="pid",
            full_name="yggdrasil.RegistrationRequest.pid",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="detached_content",
            full_name="yggdrasil.RegistrationRequest.detached_content",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="yggdrasil.RegistrationRequest.features",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _REGISTRATIONREQUEST_FEATURESENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_REGISTRATIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="registered",
            full_name="yggdrasil.RegistrationResponse.registered",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="address",
            full_name="yggdrasil.RegistrationResponse.address",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_DATA_METADATAENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="yggdrasil.Data.MetadataEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="yggdrasil.Data.MetadataEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_DATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message_id",
            full_name="yggdrasil.Data.message_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="metadata",
            full_name="yggdrasil.Data.metadata",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="content",
            full_name="yggdrasil.Data.content",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="response_to",
            full_name="yggdrasil.Data.response_to",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="directive",
            full_name="yggdrasil.Data.directive",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_REGISTRATIONREQUEST.fields_by_name["features"].message_type = (
    _REGISTRATIONREQUEST_FEATURESENTRY
)
